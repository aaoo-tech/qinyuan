          ...
          <div class="common-table">
            ...
            <div class="table-foot">
              <div class="left-cont fl">
                <a class="btn" href="/famous/recycleoption?idlist=&optype=4" >批量删除</a>
                <a class="btn" href="/famous/recycleoption?idlist=&optype=3" >批量还原</a>
              </div>
              <div class="right-cont">
                <a class="btn" href="/famous/recycleoption?idlist=&optype=1" >还原所有</a>
                <a class="btn" href="/famous/recycleoption?idlist=&optype=2" >删除所有</a>
              </div>
            </div>
          </div>
