            ...
            <table>
              ...
              @foreach ($data as $datum)
                <tr>
                  ...
                  <td>{{$datum['job']}}</td>
                  <td>{{$datum['money']}}</td>
                  <td><a class="link-edit" href="/merit/recycleoption?idlist={{$datum['id']}}&optype=3" >还原</a><a class="link-remove" href="/merit/recycleoption?idlist={{$datum['id']}}&optype=4" >删除</a></td>
                </tr>
              @endforeach
              @endif
              </tbody>
